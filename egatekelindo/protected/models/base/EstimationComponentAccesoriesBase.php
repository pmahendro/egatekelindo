 ...
 */
class EstimationComponentAccesoriesBase extends ActiveRecord
{
	public function tableName()
	{
		return 'tblet_estimation_component_accesories';
	}

	public function rules()
	{
		return array(
			array('name, quantity, estimation_panel_id', 'required'),
			array('brand_id, estimation_panel_id, estimation_brand_discount_id, component_id, component_cu_id, accesories_phase_id, sort_number, is_lot, is_inactive', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>100),
			array('weight, quantity', 'length', 'max'=>10),
	...
	{
		return array(
			'budgetingDetailAccesories' => array(self::HAS_MANY, 'BudgetingDetailAccesories', 'estimation_component_accesories_id'),
