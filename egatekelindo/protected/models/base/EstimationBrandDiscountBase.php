 ...
 */
class EstimationBrandDiscountBase extends ActiveRecord
{
	public function tableName()
	{
		return 'tblet_estimation_brand_discount';
	}
	...
	public function relations()
	{
		return array(
			...
			'estimationComponents' => array(self::HAS_MANY, 'EstimationComponent', 'estimation_brand_discount_id'),
			'estimationComponentAccesories' => array(self::HAS_MANY, 'EstimationComponentAccesories', 'estimation_brand_discount_id'),
			'estimationComponentAccesoriesHistories' => array(self::HAS_MANY, 'EstimationComponentAccesoriesHistory', 'estimation_brand_discount_id'),
			'estimationComponentHistories' => array(self::HAS_MANY, 'EstimationComponentHistory', 'estimation_brand_discount_id'),
		);
	}
