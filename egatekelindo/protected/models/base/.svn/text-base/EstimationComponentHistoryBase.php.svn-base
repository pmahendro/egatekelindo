 ...
 */
class EstimationComponentHistoryBase extends ActiveRecord
{
	public function tableName()
	{
		return 'tblet_estimation_component_history';
	}

	public function rules()
	{
		return array(
			array('name, brand_id, estimation_panel_id, estimation_component_group_id, component_id', 'required'),
